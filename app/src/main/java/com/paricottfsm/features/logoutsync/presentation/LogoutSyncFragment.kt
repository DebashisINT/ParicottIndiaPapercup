package com.paricottfsm.features.logoutsync.presentation
...
import com.paricottfsm.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.paricottfsm.features.billing.api.AddBillingRepoProvider
import com.paricottfsm.features.billing.model.AddBillingInputParamsModel
...
import com.paricottfsm.features.dashboard.presentation.ReasonDialog
...
import com.paricottfsm.features.nearbyshops.api.updateaddress.ShopAddressUpdateRepoProvider
import com.paricottfsm.features.nearbyshops.model.updateaddress.AddressUpdateRequest
import com.paricottfsm.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
import com.paricottfsm.features.orderhistory.api.LocationUpdateRepositoryProviders
import com.paricottfsm.features.orderhistory.model.*
...
import com.paricottfsm.features.quotation.model.AddQuotInputModel
import com.paricottfsm.features.shopdetail.presentation.api.EditShopRepoProvider
import com.paricottfsm.features.shopdetail.presentation.api.addcollection.AddCollectionRepoProvider
import com.paricottfsm.features.shopdetail.presentation.model.addcollection.AddCollectionInputParamsModel
...
import com.paricottfsm.features.stockAddCurrentStock.ShopAddCurrentStockList
...
import com.paricottfsm.features.stockCompetetorStock.ShopAddCompetetorStockProductList
...
import com.paricottfsm.features.timesheet.model.AddTimeSheetInputModel
import com.paricottfsm.features.viewAllOrder.api.addorder.AddOrderRepoProvider
import com.paricottfsm.features.viewAllOrder.model.AddOrderInputParamsModel
...
import com.paricottfsm.MonitorService
...
import com.paricottfsm.features.performance.model.Gps_status_list
import com.paricottfsm.features.performance.model.UpdateGpsInputListParamsModel
import com.paricottfsm.features.returnsOrder.ReturnProductList
import com.paricottfsm.features.returnsOrder.ReturnRequest
import com.paricottfsm.features.viewAllOrder.model.NewOrderSaveApiModel
...
//            checkToCallActivity()
    ...
    private fun callLogshareApi(){
        ...
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xparicottfsmlogsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xparicottfsmlogsample/log.zip").path))).use { out ->
                ...
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xparicottfsmlogsample/log.zip").path);
